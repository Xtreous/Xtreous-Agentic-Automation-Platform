...
```bash
git remote add encore encore://leap-app-vvwi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/leap-app-vvwi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/leap-app-vvwi/settings/integrations/github)
